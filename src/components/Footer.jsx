...
export default function Footer() {
  ...
  const socialLinks = [
    { icon: Instagram, href: 'https://www.instagram.com/ppsw_banten?igsh=MXQxOGZmZ3Z2aXBoOA==', color: 'hover:text-primary hover:bg-primary/10' },
    { icon: Facebook, href: 'https://www.facebook.com/share/1GrXNJzXHd/', color: 'hover:text-secondary hover:bg-secondary/10' },
    { icon: Youtube, href: 'https://www.youtube.com/channel/UCmNuFiVnJRlkaRo6idQCu9A', color: 'hover:text-primary hover:bg-primary/10' }
  ];
